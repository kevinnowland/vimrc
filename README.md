...
Over the last 10 years, [this person](https://github.com/amix/vimrc) has used and tweaked Vim. This configuration is the ultimate vimrc (or at least my version of it).

There are two versions:

* **The Basic**: If you want something small just copy [basic.vim](https://github.com/kevinnowland/vimrc/blob/master/vimrcs/basic.vim) into your ~/.vimrc and you will have a good basic setup
...
The awesome version includes a lot of great plugins, configurations and color schemes that make Vim a lot better. To install it simply do following from your terminal:
	...
	git clone --depth=1 https://github.com/kevinnowland/vimrc.git ~/.vim_runtime
	sh ~/.vim_runtime/install_awesome_vimrc.sh
	
### Install for multiple users
To install for multiple users, the repository needs to be cloned to a location accessible for all the intended users.

	git clone --depth=1 https://github.com/kevinnowland/vimrc.git /opt/vim_runtime
...
The basic version is just one file and no plugins. Just copy [basic.vim](https://github.com/kevinnowland/vimrc/blob/master/vimrcs/basic.vim) and paste it into your vimrc.
...
Distraction free mode using [goyo.vim](https://github.com/junegunn/goyo.vim) and [vim-zenroom2](https://github.com/kevinnowland/vim-zenroom2):
...
* [goyo.vim](https://github.com/junegunn/goyo.vim) and [vim-zenroom2](https://github.com/kevinnowland/vim-zenroom2): 
* [lightline.vim](https://github.com/itchyny/lightline.vim): A light and configurable statusline/tabline for Vim
* [NERD Tree](https://github.com/scrooloose/nerdtree): A tree explorer plugin for vim
* [open_file_under_cursor.vim](https://github.com/kevinnowland/open_file_under_cursor.vim): Open file under cursor when pressing `gf`
...
* [vim-zenroom2](https://github.com/kevinnowland/vim-zenroom2) Remove all clutter and focus only on the essential. Similar to iA Writer or Write Room
